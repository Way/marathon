...
tasks of this app. If you do not specify this, Marathon considers all resource offers except you override the
default with the `--default_accepted_resource_roles` command line flag on startup.
